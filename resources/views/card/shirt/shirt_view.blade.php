...
<head>
    ...
    <link rel="stylesheet" href="/css/card/shirt.css">
    ...
    <ul class="cards">
        <li class="cards__item">
            <div class="card">
                ...
                <div class="card__content">
                    <div class="card__title">Gray T-shirt</div>
        ...
        <li class="cards__item">
            <div class="card">
                ...
                <div class="card__content">
                    <div class="card__title">Black T-shirt</div>
        ...
        <li class="cards__item">
            <div class="card">
                ...
                <div class="card__content">
                    <div class="card__title">Blue T-shirt</div>
        ...
        <li class="cards__item">
            <div class="card">
                ...
                <div class="card__content">
                    <div class="card__title">Red T-shirt</div>
